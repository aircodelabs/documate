...
<template>
<button type="button" class="documate-button" aria-label="Ask AI" @click="open = true">
  <svg class="icon" viewBox="0 0 12 14" fill="currentColor">
    <path
      fill-rule="evenodd"
      clip-rule="evenodd"
  ...
  <span class="button-placeholder">Ask AI</span>
</button>
